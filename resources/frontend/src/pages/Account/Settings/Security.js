      ...
      <PageHeaderWrapper>
        <div className={styles.container}>
          ...
          <div className={styles.content}>
            <div><span className={styles.title}>账户安全</span></div>
            <div>
            <Form onSubmit={this.handleSubmit}>
              <Form.Item style={{ marginBottom: 8 }} {...formItemLayout} label="原密码">
                {getFieldDecorator('oldPassword', {
                  ...
                  <Input className={styles.smallItem} type="password" placeholder="请输入原密码" />
                )}
              </Form.Item>
              <Form.Item style={{ marginBottom: 8 }} {...formItemLayout} label="新密码">
                {getFieldDecorator('password', {
                  ...
                  <Input className={styles.smallItem} type="password" placeholder="请输入新密码" />
                )}
              </Form.Item>
              <Form.Item style={{ marginBottom: 8 }} {...formItemLayout} label="确认密码">
                {getFieldDecorator('repassword', {
                  ...
                  <Input className={styles.smallItem} type="password" placeholder="请输入确认密码" />
                )}
              </Form.Item>
