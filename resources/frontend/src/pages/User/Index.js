    ...
    const columns = [
      {
        ...
        key: 'cover_path',
        render: (text, record ) => <a href="javascript:;" onClick={() => this.handleEdit(record.id)}><img src={text} width={40} height={40}></img></a>,
      },
      {
        title: '用户名',
        dataIndex: 'name',
      ...
      },
      {
        ...
        render: (text, record ) => (
          <span>
            <a href="javascript:;" onClick={() => this.handleRecharge(record.id)}>充值</a>
            ...
            <Row type="flex" justify="start">
              ...
              <Col span={12}>
                <div className={styles.floatRight}>
                  <Button type="primary" onClick={() => this.handleCreate()}><Icon type="plus-circle" />新增会员</Button>
                  &nbsp;
