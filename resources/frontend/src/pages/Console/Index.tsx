                  ...
                  <Row gutter={24}>
                    <Col span={8}>
                      <div className={styles.gutterBox}>
                        ...
                        <div className={styles.gutterNum}><a href="#">10</a></div>
                      </div>
                      <Divider />
                    </Col>
                    <Col span={8}>
                    ...
                    <div className={styles.gutterBoxNoBottom}>
                      ...
                      <Badge dot>
                        <a className={styles.updateSystem} href="#/console/update">1.0.2<Icon type="arrow-up" /></a>
                      </Badge>
                      </div>
                    </div>
                    </Col>
                  ...
                  <Row gutter={24} className={styles.fastRow}>
                    ...
                    <a href='#/article/create'>
                      <div className={styles.fastBox}>
                        <p><Icon className={styles.fastIcon} type="edit" /></p>
                        <p>添加文章</p>
                      </div>
                    </a>
                    </Col>
                    ...
                    <a href='#/page/create'>
                      <div className={styles.fastBox}>
                        <p><Icon className={styles.fastIcon} type="money-collect" /></p>
                        <p>添加单页</p>
                      </div>
                    </a>
                    </Col>
                    ...
                    <a href='#/banner/banner/index'>
                      <div className={styles.fastBox}>
                        <p><Icon className={styles.fastIcon} type="picture" /></p>
                        <p>幻灯片管理</p>
                      </div>
                    </a>
                    </Col>
                    ...
                    <a href='#/plugin/comment/index'>
                      <div className={styles.fastBox}>
                        <p><Icon className={styles.fastIcon} type="message" /></p>
                        <p>评论管理</p>
                      </div>
                    </a>
                    </Col>
                    ...
                    <a href='#/system/menu/index'>
                      <div className={styles.fastBox}>
                        <p><Icon className={styles.fastIcon} type="menu" /></p>
                        <p>菜单管理</p>
                      </div>
                    </a>
                    </Col>
                    ...
                    <a href='#/user/index'>
                      <div className={styles.fastBox}>
                        <p><Icon className={styles.fastIcon} type="user" /></p>
                        <p>用户管理</p>
                      </div>
                    </a>
                    </Col>
                    ...
                    <a href='#/system/navigation/index'>
                      <div className={styles.fastBox}>
                        <p><Icon className={styles.fastIcon} type="bars" /></p>
                        <p>导航管理</p>
                      </div>
                    </a>
                    </Col>
                    ...
                    <a href='#/attachment/file/index'>
                      <div className={styles.fastBox}>
                        <p><Icon className={styles.fastIcon} type="paper-clip" /></p>
                        <p>附件空间</p>
                      </div>
                    </a>
                    </Col>
