    ...
    this.props.dispatch({
        ...
        callback: (res) => {
          ...
          if (res) {
            ...
            // 接口得到数据，放到state里
            this.setState({ data:res.data.comment,coverList: res.data.comment.cover_list,loading:false});
          }
        }
    });
  }
          ...
          <Form onSubmit={this.handleSubmit}>
            ...
            <Form.Item style={{ marginBottom: 8 }} {...formItemLayout} label="内容">
              {getFieldDecorator('content',{
                ...
                <TextArea className={styles.middleItem} placeholder="请输入内容" autosize={{ minRows: 3, maxRows: 6 }} />
              )}
            </Form.Item>
