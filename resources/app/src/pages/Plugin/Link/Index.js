  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        key: '',
        render:(text,record) => {
          return <div style={{width:'100px',height:'30px',overflow:'hidden'}}><img src={text.cover_path} alt="" style={{width:'100%'}} /></div>
        }
      },
      {
        title: '状态',
            ...
            <Row type="flex" justify="start">
              ...
              <Col span={12}>
                <div className={styles.floatRight}>
                  <Button type="primary" onClick={() => this.handleCreate()}><Icon type="plus-circle" />添加链接</Button>
                </div>
              </Col>
            </Row>
          </div>
