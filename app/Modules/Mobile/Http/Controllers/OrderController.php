...
class OrderController extends Controller
{
    ...
    public function info(Request $request)
    {
        ...
        return view('order/info',compact('goods','totalMoney','reduceMoney','jsonData','cartIds'));
    }
    ...
    public function confirm(Request $request)
    {
        ...
        return view('order/confirm',compact('order','orderDetails','reduceMoney','promotionText','totalMoney'));
    }
