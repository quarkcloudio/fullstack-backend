    ...
    <div class="col-md-6"> 
        <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative"> 
            <div class="col p-4 d-flex flex-column position-static"> 
                ...
                <a href="/mobile/article/detail?id={{$article['id']}}" class="stretched-link">查看更多</a> 
            </div>
  ...
  <main role="main" class="container"> 
   <div class="row"> 
    <div class="col-md-8 blog-main"> 
     ...
     <div class="blog-post"> 
      <h2 class="blog-post-title"><a href="/mobile/article/detail?id={{$article['id']}}">{{ $helper::msubstr($article['title'],0,30) }}</a></h2> 
