...
class GoodsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('wechat/'.$indexTpl,compact('goods','jsApi'));
    }
    ...
    public function lists(Request $request)
    {
        ...
        return view('wechat/'.$category->lists_tpl,compact('goods','category','jsApi'));
    }
    ...
    public function detail(Request $request)
    {
        ...
        return view('wechat/'.$category->detail_tpl,compact('goods','spuAttributes','skuAttributes','category','jsApi'));
    }
