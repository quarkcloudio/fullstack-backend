...
class GoodsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('mobile/'.$indexTpl,compact('goods','jsApi'));
    }
    ...
    public function lists(Request $request)
    {
        ...
        return view('mobile/'.$category->lists_tpl,compact('goods','category','jsApi'));
    }
    ...
    public function detail(Request $request)
    {
        ...
        return view('mobile/'.$category->detail_tpl,compact('goods','spuAttributes','skuAttributes','category','jsApi'));
    }
