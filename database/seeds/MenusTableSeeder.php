...
class MenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('menus')->insert([
            ['id' =>1,'name' => '控制台','guard_name' => 'admin','icon' => 'icon-home','pid' => 0,'sort' => -2,'path' => '/dashboard','show'  => 1,'status' => 1],
            ['id' =>2,'name' => '主页','guard_name' => 'admin','icon' => '','pid' => 1,'sort' => 0,'path' => '/dashboard/index','show'  => 1,'status' => 1],

            ['id' => 3,'name' => '文章管理','guard_name' => 'admin','icon' => 'icon-article','pid' => 0,'sort' => 0,'path' => '/article','show'  => 1,'status' => 1],
            ...
            ['id' => 7,'name' => '单页管理','guard_name' => 'admin','icon' => 'icon-page','pid' => 0,'sort' => 0,'path' => '/page','show'  => 1,'status' => 1],
            ...
            ['id' => 10,'name' => '会员管理','guard_name' => 'admin','icon' => 'icon-useradd','pid' => 0,'sort' => 0,'path' => '/user','show'  => 1,'status' => 1],
            ...
            ['id' =>13,'name' => '管理员','guard_name' => 'admin','icon' => 'icon-admin','pid' => 0,'sort' => 0,'path' => '/admin','show'  => 1,'status' => 1],
            ...
            ['id' =>18,'name' => '广告管理','guard_name' => 'admin','icon' => 'icon-banner','pid' => 0,'sort' => 0,'path' => '/banner','show'  => 1,'status' => 1],
            ...
            ['id' =>21,'name' => '应用插件','guard_name' => 'admin','icon' => 'icon-plugin','pid' => 0,'sort' => 0,'path' => '/plugin','show'  => 1,'status' => 1],
            ...
            ['id' =>25,'name' => '系统配置','guard_name' => 'admin','icon' => 'icon-setting','pid' => 0,'sort' => 0,'path' => '/system','show'  => 1,'status' => 1],
            ...
            ['id' =>33,'name' => '附件空间','guard_name' => 'admin','icon' => 'icon-attachment','pid' => 0,'sort' => 0,'path' => '/attachment','show'  => 1,'status' => 1],
            ...
            ['id' =>36,'name' => '我的账号','guard_name' => 'admin','icon' => 'icon-user','pid' => 0,'sort' => 0,'path' => '/account','show'  => 1,'status' => 1],
            ['id' =>37,'name' => '个人设置','guard_name' => 'admin','icon' => '','pid' => 36,'sort' => 0,'path' => '/account/settings','show'  => 1,'status' => 1],

            ['id' =>'38','name' => '商城管理','guard_name' => 'admin','icon' => 'icon-shop','pid' => '0','sort' => '-1','path' => '/mall','show'  => '1','status' => '1'],
